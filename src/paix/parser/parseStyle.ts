...
export interface PaixStyleParseResult {
  ast: PaixStyleNode | null;
  diagnostics: PaixDiagnostic[];
}

export function parsePaixStyle(
  source: string,
): PaixStyleParseResult {
  ...
  return {
    ast: paixAstVisitor.visit(cst) as PaixStyleNode,
    diagnostics: [],
  };
}